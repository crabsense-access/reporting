...
import { formatBucketLabel } from "@/components/dashboard/GA4TrendChart";
...
export function sentimentFromVariation(current: number, previous: number | null, higherIsBetter: boolean): InsightSentiment {
...
export function buildMiniSeries(points: GA4TimeSeriesPoint[], key: GA4BasicMetricKey) {
...
interface GA4MetricCardProps {
  ...
  color: string | null;
  onSelect: (key: GA4BasicMetricKey) => void;
}

// Scorecard autocontenido para las 4 métricas básicas de Analítica — mismo
// diseño que MetaAdsMetricCard/GoogleAdsMetricCard. El insight arranca
// oculto por defecto, un botón lo despliega/oculta.
export function GA4MetricCard({
  metricKey,
  label,
  value,
  formatValue,
