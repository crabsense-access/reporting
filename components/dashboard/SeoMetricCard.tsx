...
import { formatBucketLabel } from "@/components/dashboard/SeoTrendChart";
...
export function buildMiniSeries(points: SeoTimeSeriesPoint[], key: SeoMetricKey) {
...
interface SeoMetricCardProps {
  ...
  color: string | null;
  onSelect: (key: SeoMetricKey) => void;
}

// Scorecard autocontenido para las 4 métricas de cada segmento de SEO —
// mismo diseño que MetaAdsMetricCard/GoogleAdsMetricCard/GA4MetricCard. El
// insight arranca oculto por defecto, un botón lo despliega/oculta.
