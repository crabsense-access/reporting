...
import { ConfiguracionV3Form } from "@/components/admin/configuracion-v3/ConfiguracionV3Form";
...
export default async function ConfiguracionV3Page() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <h1 className="text-2xl font-semibold text-foreground">Configuración v3</h1>
      </div>
      <ConfiguracionV3Form clients={clientsWithSources} />
    </div>
  );
}
