...
import { MetaAdsCostosDashboard } from "@/components/dashboard/MetaAdsCostosDashboard";

export default async function MetaAdsCostosPage({
  params,
}: {
  ...
  return <MetaAdsCostosDashboard clientId={client.id} breadcrumbSubtitle="Costos de Meta Ads" />;
}
